...
export class SelectService {
  ...
  getCountry(id):Country{
    console.log(this.getCountries().find((item) => item.id == id));
   return this.getCountries().find((item) => item.id == id);
  }
  getState(id):State{
    console.log(this.getStates().find((item) => item.id == id));
   return this.getStates().find((item) => item.id == id);
  }
